    ...
    return (
      <Layout name={'single'}>
        ...
        <div className="single-content">
          <h1>Betyg</h1>
          <p>För att bibehålla kvalité har vi på Smartval valt att vara helt transparenta och helt opartiska när det kommer till betygsutdelning och rang på vår sida. Håller du inte med eller har några synpunkter är du välkommen att <Link to="/kontakt">ta kontakt med oss</Link>.</p>
